...
OUTPUT_VIDEO  = "../assets/results_yolo5n_method/output_yolo5n.mp4"
JSON_METRICS  = "../assets/results_yolo5n_method/yolo5n_metrics.json"
WEIGHTS       = "../assets/models/yolov5n.pt"
